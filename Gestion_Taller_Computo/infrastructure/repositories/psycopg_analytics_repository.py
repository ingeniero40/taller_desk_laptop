...
class Psycopg2AnalyticsRepository(IAnalyticsRepository):
    ...
    def get_revenue_stats(self, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
        ...
        payments_total = self.db.executeRawQuery(query_payments, (start_date, end_date), fetch=True)
        invoices_total = self.db.executeRawQuery(query_invoices, (start_date, end_date), fetch=True)
