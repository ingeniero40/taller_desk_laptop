            ...
            rx.vstack(
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.badge("Contexto 9", color_scheme="indigo", variant="solid", size="1"),
                        spacing="2",
                    ),
                    rx.upload(
                        rx.vstack(
                            rx.button("Seleccionar Fotos (Antes)", variant="soft", color_scheme="indigo"),
        ...
        rx.grid(
            ...
            rx.card(
                rx.vstack(
                    ...
                    rx.cond(
                        AdmissionState.new_customer_mode,
                        rx.badge("Nuevo cliente", color_scheme="indigo", variant="soft", size="1"),
