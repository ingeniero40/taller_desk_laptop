...
class BillingManager:
    def __init__(self, invoice_repo: IInvoiceRepository, payment_repo: IPaymentRepository):
        self.invoice_repo = invoice_repo
        self.payment_repo = payment_repo

    def create_invoice_from_work_order(self, work_order_id: uuid.UUID, customer_id: uuid.UUID, 
                                     amount: float, tax_rate: float = 0.16) -> Invoice:
        """
    ...
    def process_payment(self, invoice_id: uuid.UUID, amount: float, 
                        method: PaymentMethod, reference: str = None) -> Payment:
        """
