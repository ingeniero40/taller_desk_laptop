...
class DeviceManager:
    ...
    def register_device(
        self, brand: str, model: str, serial_number: str, customer_id: uuid.UUID
    ) -> Device:
        """
        ...
        if existing:
            raise ValueError(
                f"El dispositivo con serie '{serial_number}' ya está registrado."
            )
    ...
    def update_device_info(
        self, device_id: uuid.UUID, brand: str = None, model: str = None
    ) -> Device:
